...
except ImportError:  # qc_neural only available in Colab/training environment
    RecordingNormalizer = None  # type: ignore[assignment,misc]


class _IdentityRecordingNormalizer:
    """Fallback normalizer for local environments without qc_neural."""
...
class QCTransferBenchmark:
    ...
    def prepare_data(self) -> _PreparedTransferData:
        ...
        df = cleaned.copy()
        normalizer = RecordingNormalizer() if RecordingNormalizer is not None else _IdentityRecordingNormalizer()
