...
from qc_thesis.modeling.stacking.fpos_backend_sweep import _grouped_oof_splits
from qc_thesis.modeling.stacking.methods import score_predictions
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-dir",
        default="artifacts/modeling/stacking/fpos_signal_embedding_stack_full_v1/explainability_v1",
    )
...
def _refit_current_winner(
    ...
    config = FPosSignalEmbeddingStackConfig(
        ...
        output_root=Path("artifacts/modeling/stacking"),
...
def run_report(parquet_path: Path, output_dir: Path) -> dict[str, str]:
    ...
    report_lines = [
        ...
        "- run: `artifacts/modeling/stacking/fpos_signal_embedding_stack_full_v1`",
        "",
        "## Main Metrics",
        "",
