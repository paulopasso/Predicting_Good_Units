...
- the gain was not strong enough to beat the earlier global waveform-augmented stack model:
  - `wf_embed_anchor_stack_xgboost`
  - MAE `0.1140`
  - `R² 0.5479`
...
- waveform-augmented stack model:
  - macro `R² 0.4386`
  - weighted `R² 0.4116`
  - worst-family `R² 0.1482`

Per-family results for the waveform-augmented stack model:
...
- for standard recording-disjoint evaluation, keep the waveform-augmented stack model as the best `fpos` model
