...
The thesis is organised around four hypotheses that reflect the most significant uncertainties.
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{@{}lY@{}}
        ...
        \midrule
        H1 & Hybrid and paired data are strongly shifted, making naive source-only transfer insufficient for reliable quality prediction. \\
...
H1 questions the existence of a meaningful transfer problem that would require methods more complex than source-only transfer. H2 tests whether information at the recording level can add significant signal. H3 and H4 move beyond performance and question the heterogeneity of our targets as well as whether different models perform better under different paired-recording families.
...
\begin{itemize}
    ...
    \item It quantifies the hybrid-to-paired domain shift, showing near-perfect domain separability.
    \item It compares multiple families of transfer methods, including source-only transfer, context-aware stacking, unlabeled target structure, and waveform-enriched stacking.
    ...
    \item It demonstrates that paired-domain family structure matters. The best \fpos{} model differs across paired-recording families.
\end{itemize}
